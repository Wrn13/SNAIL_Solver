...
Usage
-----
    python -m snail_solver.plot_results --outdir results_zhou/ --figdir results_zhou/figs/
    python -m snail_solver.plot_results --outdir results_zhou/ --figdir figs/ --usetex
    # one figure only:
    python -m snail_solver.plot_results --outdir results_zhou/ --only heatmap --metric leakage
"""
