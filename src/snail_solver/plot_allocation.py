...
CLI
---
    python -m snail_solver.plot_allocation --device evan_device.json --out figs/allocation.png
    python -m snail_solver.plot_allocation --device evan_device.json --spec 4.0        # mark a placement
    python -m snail_solver.plot_allocation --device evan_device.json --sweep-detuning 0.0,2.2   # show a swept band
"""
...
def main() -> None:
    ap = argparse.ArgumentParser(
        prog="python -m snail_solver.plot_allocation",
        description="Frequency-allocation diagram")
