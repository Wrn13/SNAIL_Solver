...
Usage
-----
    python -m snail_solver.plot_bare_sweep --outdir <name>            # reads results/<name>/summary.csv
    python -m snail_solver.plot_bare_sweep --csv path/to/summary.csv --xaxis wb
"""
...
def main() -> None:
    ap = argparse.ArgumentParser(
        prog="python -m snail_solver.plot_bare_sweep", description=__doc__,
