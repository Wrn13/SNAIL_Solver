...
Usage
-----
    python -m snail_solver.calibrate_gate --device dev.json --target-eta 1.5 \
...
from snail_solver.device_utils import (
    load_device, auto_t_g, build_coupler, transfer_probability, maximize_1d,
)
...
def main() -> None:
    ...
    ap = argparse.ArgumentParser(
        prog="python -m snail_solver.calibrate_gate", description=__doc__,
